...
//    //auto material_left = make_shared<metal>(1.5);
...
//	auto material_left = make_shared<metal>(color(0.5, 0.8, 0.2), 0.5);
//	auto material_right = make_shared<metal>(color(0.1, 0.7, 0.3), 0.6);
